...
\begin{figure*}
  \centering
   \includegraphics[width=.33\textwidth]{pic/out_1.png}
   \includegraphics[width=.3\textwidth]{pic/out_2.png}
   \includegraphics[width=.3\textwidth]{pic/out_7.png}
  \centering
   \includegraphics[width=.33\textwidth]{pic/out_5.png}
   \includegraphics[width=.3\textwidth]{pic/out_6.png}
   \includegraphics[width=.3\textwidth]{pic/out_4.png}
   \caption{Example Outputs of our network}
\end{figure*}

\begin{figure*}
  \centering
   \includegraphics[width=.3\textwidth]{pic/out_8.png}
   \includegraphics[width=.3\textwidth]{pic/out_9.png}
   \includegraphics[width=.33\textwidth]{pic/out_10.png}
  \centering
   \includegraphics[width=.3\textwidth]{pic/out_11.png}
   \includegraphics[width=.33\textwidth]{pic/out_13.png}
   \includegraphics[width=.3\textwidth]{pic/out_14.png}
   \caption{Example Outputs of our network}
\end{figure*}
