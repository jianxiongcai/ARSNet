...
ARSNet   		  & 900 & VOC07 &\textbf{73.2}  & \textbf{74.5} & 81.5 & \textbf{71.1} & \textbf{56.7} & \textbf{56.2} & \textbf{83.6} & \textbf{85.8} & \textbf{87.4} & 51.4 & \textbf{82.7} & 68.9 & \textbf{83.8} & \textbf{86.5} & \textbf{77.1} &  \textbf{81.0} & 43.9 & \textbf{73.0} & \textbf{66.4} & 79.7 & \textbf{72.6}
\end{tabular}
}
\end{table*}
